...
%TODO: verify source
%Deductive approach
The plan is to make an confirmatory investigation using quantitative data/operations with a deductive approach. This is a quantitative research method where data is gathered during experiments and from simulations of the environment \cite{hakansson2013}. \\ %Gather data from simulations and from real tests, iterated many times.
%TODO: Bättre
