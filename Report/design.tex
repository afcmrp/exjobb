...
To maintain secure communication between the two vehicles in the platoon a communication protocol will be developed. For more information, see the report by~\cite{lerander2017}.% WiFi will be used to communicate wirelessly, and  WiFi messages will be parsed in a MicroBlaze processor in the FPGA and sent to the OS. 
