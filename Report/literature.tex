...
Developing functions to standards of different ASIL levels have different costs. The different ASILs can relate to cost according to various cost heuristics, see table~\ref{table:cost_heuritics}. %TODO: Expand, wording
